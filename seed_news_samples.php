...
$newsItems = [
    [
        ...
        'content' => '<p><strong>SAN FRANCISCO (Reuters Tech Wire)</strong> — In a significant leap for generative artificial intelligence models, Anthropic has officially unveiled Claude 3.7 Sonnet. The model marks the industry’s first production hybrid reasoning architecture, capable of producing near-zero latency standard answers while dynamically switching to deep chain-of-thought verification when presented with complex mathematical or algorithmic coding dilemmas.</p>
...
<blockquote><p>"The boundary between conversational responsiveness and deep deliberate reasoning is dissolving," stated Anthropic research lead in an official morning briefing. "Engineers should not be forced to choose between interactive speed and deep logical rigor."</p></blockquote>
...
<p>Major cloud platforms including AWS Bedrock and Google Cloud Vertex AI have announced immediate preview availability for enterprise customers beginning this morning.</p>',
    ...
    [
        ...
        'content' => '<p><strong>WASHINGTON (Associated Press)</strong> — CISA published an emergency binding directive Tuesday morning following active zero-day exploitation targeting peripheral routing hardware across key communications infrastructure providers.</p>
...
<p>Network security researchers discovered proof-of-concept exploits actively exchanging hands in subterranean security channels late Monday evening, prompting the expedited federal intervention.</p>',
    ...
    [
        ...
        'summary' => 'NEW YORK — Open foundation model benchmarks released today highlight a 65% reduction in training and inference costs, driven by sparse activation patterns and advanced speculative decoding routines.',
        'content' => '<p><strong>NEW YORK (Bloomberg)</strong> — Global technology researchers and open-source practitioners received a major efficiency boost this week as benchmark datasets for next-generation Mixture-of-Experts (MoE) architectures revealed unprecedented price-to-performance efficiency.</p>
